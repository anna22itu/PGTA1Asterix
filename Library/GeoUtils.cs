...
namespace Library
{
    public class GeoUtils
    {
        ...
        //public static double Aa = 6378137.0;
        /// <summary>
        ...
        //public static double Ee2 = 0.00669437999013;
        ...
        public CoordinatesWGS84 change_geocentric2geodesic(CoordinatesXYZ c)
        {
            ...
            res.Lat = Math.Atan((c.Z / d_xy) /
                (1 - (A * E2) / Math.Sqrt(d_xy * d_xy + c.Z * c.Z)));
            // from formula 24
            double nu = A / Math.Sqrt(1 - E2 * Math.Pow(Math.Sin(res.Lat), 2.0));
            // from formula 20
        ...
        public CoordinatesWGS84 setCenterProjection(CoordinatesWGS84 c)
        {
            ...
            T1 = GeoUtils.CalculateTranslationMatrix(c2, this.A, this.E2);
            R1 = GeoUtils.CalculateRotationMatrix(c2.Lat, c2.Lon);
